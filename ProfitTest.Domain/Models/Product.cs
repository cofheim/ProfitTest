namespace ProfitTest.Domain.Models
{
    public class Product
    {
        ...
        public DateTime PriceValidFrom { get; private set; } // период действи€ цены ќ“
        public DateTime? PriceValidTo { get; private set; } // период действи€ цены ƒќ
        public DateTime CreatedAt { get; }

        // фабричный метод дл€ создани€ товара
        ...
        // фабричный метод дл€ обновлени€ товара
